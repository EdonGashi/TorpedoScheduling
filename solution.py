...
class Solver:
    ...
    def find_initial_solution(self):
        ...
        satisfied.
        '''
        matrix = self.instance.create_adjacency_matrix()
        num_bf = len(self.instance.bf_schedules)
        num_converters = len(self.instance.converter_schedules)
        ...
        while converter_id < num_converters:
            ...
            if stack[converter_id] == -1:
                # No feasible value could be assigned, cycle previous converter.
